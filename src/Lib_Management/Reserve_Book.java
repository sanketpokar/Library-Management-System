 ...
 * @author nayan
 */
public class Reserve_Book extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField7.getText().compareTo("Issued") == 0){ 
            try{
                Connection con = ConnectionProvider.getCon();
                Statement st = con.createStatement();
                st.executeUpdate("update book set status='Reserved' where book_Id='"+bookID+"'");
            }
            ...
            try{
                ...
                if(rs.next()){
                  ...
                  if(!isAdmin) st.executeUpdate("insert into transaction values(null,'"+title+"','0','1','0','"+dateFormat.format(cal.getTime())+"','"+StudentID+"',NULL,'"+bookID+"')");
                  else st.executeUpdate("insert into transaction values(null,'"+title+"','0','1','0','"+dateFormat.format(cal.getTime())+"',null,'"+StudentID+"','"+bookID+"')");                }
                else{
                    JOptionPane.showMessageDialog(null, "Incorrect Book ID");
                    setVisible(false);
                    new Reserve_Book().setVisible(true);
...
//                JOptionPane.showMessageDialog(null, "Connection Error");}
            ...
            DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
            Calendar cal = Calendar.getInstance();
            String message1 = "Book Reserved\nReserve Date: " + dateFormat.format(cal.getTime());
            //cal.add(Calendar.DAY_OF_YEAR, 14);
            //String message2 = "\nReturn Date: " + dateFormat.format(cal.getTime());
            JOptionPane.showMessageDialog(null, message1);
        }
        else if(jTextField7.getText().compareTo("Available") == 0) 
            JOptionPane.showMessageDialog(null, "Book is available, issue it");
        
        else JOptionPane.showMessageDialog(null, "Book is already reserved");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reserve_Book.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
